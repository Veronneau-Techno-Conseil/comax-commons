...
NAMESPACE="$2"
SECRET_NAME="$3"
KUBECFG_FILE_NAME="$(pwd)/acnt/k8s-${SERVICE_ACCOUNT_NAME}-${NAMESPACE}-conf"
TARGET_FOLDER="$(pwd)/acnt"
...
create_target_folder
#acnt already created
#create_service_account
#secret independant from account and already known
#get_secret_name_from_service_account
extract_ca_crt_from_secret
get_user_token_from_secret
set_kube_config_values
