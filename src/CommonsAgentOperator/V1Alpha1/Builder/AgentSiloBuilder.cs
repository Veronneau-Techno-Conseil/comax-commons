    ...
    public partial class DeploymentBuilder
    {
        ...
        public static IEnumerable<IKubernetesObject<V1ObjectMeta>> Build(AgentSilo silo)
        {
            var labels = new Dictionary<string, string>()
           {
            ...
            List<IKubernetesObject<V1ObjectMeta>> results = new List<IKubernetesObject<V1ObjectMeta>>();

            foreach (var o in BuildAgentSilo(silo, labels)) results.Add(o);

            foreach (var o in BuildMariaDb(silo, labels)) results.Add(o);

            foreach (var o in BuildStoreApi(silo, labels)) results.Add(o);
