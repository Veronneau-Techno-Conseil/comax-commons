...
{
    public class AgentServiceOutgoingFilter : IOutgoingGrainCallFilter
    {
        private readonly ILogger<SecureTokenOutgoingFilter> _logger;
        private readonly ITokenProvider _tokenProvider;
        private readonly AppIdProvider _appIdProvider;

        public AgentServiceOutgoingFilter(ILogger<SecureTokenOutgoingFilter> logger, ITokenProvider tokenProvider, AppIdProvider appIdProvider)
        {
            _logger = logger;
